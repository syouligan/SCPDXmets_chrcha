...
if(dir.exists("/Users/mac/cloudstor/")) {
  setwd("/Users/mac/cloudstor/sarah_projects/SCPDXmets_chrcha/project_results/seurat/practice_all_data") # Uses practice data (5% of cells from each sample) if running locally
  place <- "local"
} else {
  setwd("/share/ScratchGeneral/scoyou/sarah_projects/SCPDXmets_chrcha/project_results/seurat/all_data")
  place <- "wolfpack"
}
...
if(place == "local") {
  filtered_exp <- readRDS("/Users/mac/cloudstor/sarah_projects/SCPDXmets_chrcha/project_results/prefiltering/practice_all_data/Prefiltered_experiment_practice_merge_cluster_wCC.rds") # uses practice data if local
} else {
  filtered_exp <- readRDS("/share/ScratchGeneral/scoyou/sarah_projects/SCPDXmets_chrcha/project_results/prefiltering/all_data/Prefiltered_experiment_all_merge_cluster_wCC.rds") # uses whole dataset if wolfpack
}
