...
setwd(paste0(location, "sarah_projects/SCPDXmets_chrcha/project_results/prefiltering/"))
...
sample_IDs <- read.csv(paste0(location, "sarah_projects/SCPDXmets_chrcha/sample_metadata/Sample_ids.csv"))
