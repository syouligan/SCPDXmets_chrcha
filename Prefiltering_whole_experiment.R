...
setwd(paste0(location, "sarah_projects/SCPDXmets_chrcha/project_results/prefiltering/", folder))
...
if (place == "local") {
  raw_experiment <- readRDS(paste0(location, "sarah_projects/SCPDXmets_chrcha/project_results/prefiltering/Raw_experiment_all_samples_labeled_practice.rds")) # Load practice dataset generated after the following steps
} else {
  raw_experiment <- readRDS(paste0(location, "sarah_projects/SCPDXmets_chrcha/project_results/prefiltering/Raw_experiment_all_samples_labeled.rds")) # Load practice dataset generated after the following steps
}
